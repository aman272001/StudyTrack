...
export default function Attendance() {
  ...
  const save = async (event) => { event.preventDefault(); try { await api.post("/attendance", form); } catch (requestError) { alert(messageOf(requestError)); } };
